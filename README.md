# React Social Network Server Side Rendering (SSR)
## Features
...
### ⚠️ Take a look at [React Social Network](https://github.com/Qolzam/react-social-network) but in single page application ;)
